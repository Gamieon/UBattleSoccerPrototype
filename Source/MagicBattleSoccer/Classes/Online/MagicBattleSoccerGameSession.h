...
struct FMagicBattleSoccerSessionParams
{
	...
	TSharedPtr<FUniqueNetIdRepl> UserId;
...
public:
	...
	*/
	bool HostSession(TSharedPtr<FUniqueNetIdRepl> UserId, FName SessionName, const FString & GameType, const FString & MapName, bool bIsLAN, bool bIsPresence, int32 MaxNumPlayers);
	...
	*/
	void FindSessions(TSharedPtr<FUniqueNetIdRepl> UserId, FName SessionName, bool bIsLAN, bool bIsPresence);
